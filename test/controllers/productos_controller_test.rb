...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { descripcion: @producto.descripcion, nombre: @producto.nombre, referencia: @producto.referencia } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { descripcion: @producto.descripcion, nombre: @producto.nombre, referencia: @producto.referencia } }
